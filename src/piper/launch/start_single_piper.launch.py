...
def generate_launch_description():
    ...
    rviz_ctrl_flag_arg = DeclareLaunchArgument(
        "rviz_ctrl_flag", default_value="false", description="Start rviz flag."
    )

    gripper_exist_arg = DeclareLaunchArgument(
        "gripper_exist", default_value="true", description="gripper"
    )

    gripper_val_mutiple_arg = DeclareLaunchArgument(
        "gripper_val_mutiple", default_value="2", description="gripper"
    )
